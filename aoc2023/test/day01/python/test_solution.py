...
from aoc2023.src.day01.python.solution import sum_calibration_values
...
class TestDay01Solution(AdventOfCodeTestCase):
  ...
  def test_part1_withExampleInput_sumsCalibrationValues(self):
    self.assertEqual(142, sum_calibration_values(self.examples[0]))
