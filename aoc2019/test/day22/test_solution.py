...
class TestSolution(AdventOfCodeTestCase):
  ...
  def test_case1(self):
    ...
    self.assertEqual(self.to_int_list('0 3 6 9 2 5 8 1 4 7'),
                     shuffler.apply_techniques(self.examples[0]))

  def test_case2(self):
    shuffler = Shuffler(10)
    self.assertEqual(self.to_int_list('3 0 7 4 1 8 5 2 9 6'),
                     shuffler.apply_techniques(self.examples[1]))

  def test_case3(self):
    shuffler = Shuffler(10)
    self.assertEqual(self.to_int_list('6 3 0 7 4 1 8 5 2 9'),
                     shuffler.apply_techniques(self.examples[2]))

  def test_case4(self):
    shuffler = Shuffler(10)
    self.assertEqual(self.to_int_list('9 2 5 8 1 4 7 0 3 6'),
                     shuffler.apply_techniques(self.examples[3]))

  def test_part_one(self):
    self.assertEqual(8326, part_one(self.input, deck_size=10007, target=2019))
