...
class Shuffler:
  ...
  def apply_techniques(self, techniques: Sequence[str]) -> list:
...
def part_one(techniques: Sequence[str], deck_size: int, target: int) -> int:
  shuffler = Shuffler(deck_size)
  shuffler.apply_techniques(techniques)
